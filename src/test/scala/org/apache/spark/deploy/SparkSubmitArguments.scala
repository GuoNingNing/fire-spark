...
private[spark] class SparkSubmitArguments(args: Seq[String], env: Map[String, String] = sys.env)
  ...
  var silentRunning : Boolean = false
  ...
  val submitArgsString = args.mkString("\u0001")
  ...
  private def loadEnvironmentArguments(): Unit = {
    ...
    monitor = Option(monitor).orElse(sparkProperties.get("spark.submit.monitor")).orNull
  ...
  private def printUsageAndExit(exitCode: Int, unknownParam: Any = null): Unit = {
    ...
    outStream.println(
      s"""
        ...
        |  --monitor BOOLEAN           Spark on YARN application monitor (Default : false).
        |                              Restart after application failure.
        ...
        |  --silent                    Do not wait for the end of the application.
      """.stripMargin
    )
